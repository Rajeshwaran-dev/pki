...
const CATEGORIES = ['Laptops', 'Electronics', 'Accessories', 'Furniture', 'Networking', 'Stationery', 'Tools'];
const UNITS = ['pcs', 'kg', 'litre', 'meter', 'box', 'pack', 'set', 'roll'];
const WAREHOUSES = ['Warehouse A', 'Warehouse B', 'Site Store', 'Office Store'];

const initItems = [
  { key: '1', id: 'INV-001', name: 'MacBook Pro M2', sku: 'LAP-MBP-001', category: 'Laptops', brand: 'Apple', unit: 'pcs', quantity: 15, minStock: 5, maxStock: 30, costPrice: 124000, sellingPrice: 135000, supplier: 'Apple India Pvt Ltd', location: 'Warehouse A', status: 'In Stock', description: 'MacBook Pro with M2 chip, 8GB RAM, 256GB SSD', barcode: '123456789', lastUpdated: '2024-04-07', tags: ['laptop', 'apple', 'premium'] },
  { key: '2', id: 'INV-002', name: 'Dell UltraSharp 27"', sku: 'MON-DLL-022', category: 'Electronics', brand: 'Dell', unit: 'pcs', quantity: 5, minStock: 8, maxStock: 20, costPrice: 42000, sellingPrice: 45000, supplier: 'Dell Technologies', location: 'Warehouse A', status: 'Low Stock', description: 'Dell UltraSharp 27" 4K Monitor', barcode: '234567890', lastUpdated: '2024-04-06', tags: ['monitor', 'dell'] },
  { key: '3', id: 'INV-003', name: 'Logitech MX Master 3', sku: 'ACC-LOG-005', category: 'Accessories', brand: 'Logitech', unit: 'pcs', quantity: 25, minStock: 10, maxStock: 50, costPrice: 7500, sellingPrice: 8500, supplier: 'Tech Mart', location: 'Office Store', status: 'In Stock', description: 'Advanced wireless mouse with flow cross-computer control', barcode: '345678901', lastUpdated: '2024-04-05', tags: ['mouse', 'wireless'] },
  { key: '4', id: 'INV-004', name: 'Herman Miller Aeron', sku: 'FUR-HMN-010', category: 'Furniture', brand: 'Herman Miller', unit: 'pcs', quantity: 0, minStock: 2, maxStock: 10, costPrice: 88000, sellingPrice: 95000, supplier: 'Office Essentials', location: 'Warehouse B', status: 'Out of Stock', description: 'Ergonomic office chair with PostureFit SL', barcode: '456789012', lastUpdated: '2024-04-03', tags: ['chair', 'ergonomic'] },
  { key: '5', id: 'INV-005', name: 'RJ45 Connectors (Pack/100)', sku: 'NET-CON-100', category: 'Networking', brand: 'Generic', unit: 'pack', quantity: 85, minStock: 20, maxStock: 200, costPrice: 120, sellingPrice: 150, supplier: 'Network Pro', location: 'Site Store', status: 'In Stock', description: 'Cat6 RJ45 keystone jack connectors', barcode: '567890123', lastUpdated: '2024-04-01', tags: ['network', 'cable'] },
  { key: '6', id: 'INV-006', name: 'A4 Copy Paper (Ream)', sku: 'STA-PAP-500', category: 'Stationery', brand: 'Double A', unit: 'ream', quantity: 3, minStock: 10, maxStock: 100, costPrice: 350, sellingPrice: 380, supplier: 'Stationery World', location: 'Office Store', status: 'Low Stock', description: '80 GSM A4 copier paper, 500 sheets per ream', barcode: '678901234', lastUpdated: '2024-04-07', tags: ['paper', 'stationery'] },
];

const initSuppliers = [
  { key: '1', id: 'SUP-001', name: 'Apple India Pvt Ltd', contact: 'Rajesh Kumar', phone: '+91 98765 43210', email: 'vendor@apple.in', gst: '27ABCDE1234F1Z5', city: 'Mumbai', state: 'Maharashtra', paymentTerms: 'Net 30', rating: 5, categories: ['Laptops', 'Accessories'], status: 'Active', totalOrders: 12, totalValue: 1488000 },
  { key: '2', id: 'SUP-002', name: 'Dell Technologies', contact: 'Anita Sharma', phone: '+91 87654 32109', email: 'sales@dell.in', gst: '29DEFGH5678I2Z4', city: 'Bangalore', state: 'Karnataka', paymentTerms: 'Net 45', rating: 4, categories: ['Electronics', 'Laptops'], status: 'Active', totalOrders: 8, totalValue: 672000 },
  { key: '3', id: 'SUP-003', name: 'Tech Mart', contact: 'Sanjay Patel', phone: '+91 76543 21098', email: 'orders@techmart.com', gst: '24IJKLM9012N3Z3', city: 'Ahmedabad', state: 'Gujarat', paymentTerms: 'Advance', rating: 3, categories: ['Accessories', 'Stationery'], status: 'Active', totalOrders: 22, totalValue: 187000 },
  { key: '4', id: 'SUP-004', name: 'Office Essentials', contact: 'Meena Reddy', phone: '+91 65432 10987', email: 'orders@officeess.com', gst: '36NOPQR3456S4Z2', city: 'Hyderabad', state: 'Telangana', paymentTerms: 'Net 15', rating: 4, categories: ['Furniture'], status: 'Inactive', totalOrders: 5, totalValue: 952000 },
];

const initOrders = [
  { key: '1', poNumber: 'PO-2024-001', supplier: 'Apple India Pvt Ltd', items: 3, totalAmount: 372000, status: 'Delivered', orderDate: '2024-03-01', expectedDate: '2024-03-15', deliveredDate: '2024-03-14', createdBy: 'Admin', notes: 'Quarterly laptop procurement' },
  { key: '2', poNumber: 'PO-2024-002', supplier: 'Dell Technologies', items: 2, totalAmount: 84000, status: 'In Transit', orderDate: '2024-04-01', expectedDate: '2024-04-10', deliveredDate: null, createdBy: 'Manager', notes: 'Monitor replacements' },
  { key: '3', poNumber: 'PO-2024-003', supplier: 'Tech Mart', items: 5, totalAmount: 43750, status: 'Pending', orderDate: '2024-04-07', expectedDate: '2024-04-14', deliveredDate: null, createdBy: 'Admin', notes: 'Accessories restock' },
  { key: '4', poNumber: 'PO-2024-004', supplier: 'Office Essentials', items: 4, totalAmount: 380000, status: 'Cancelled', orderDate: '2024-02-20', expectedDate: '2024-03-05', deliveredDate: null, createdBy: 'Admin', notes: 'Furniture bulk order - cancelled due to budget freeze' },
];

const initCategories = [
  { key: '1', name: 'Laptops', description: 'Portable computing devices', items: 1, reorderLevel: 5, defaultUnit: 'pcs', status: 'Active' },
  { key: '2', name: 'Electronics', description: 'Electronic devices and gadgets', items: 1, reorderLevel: 8, defaultUnit: 'pcs', status: 'Active' },
  { key: '3', name: 'Accessories', description: 'Computer and office accessories', items: 1, reorderLevel: 10, defaultUnit: 'pcs', status: 'Active' },
  { key: '4', name: 'Furniture', description: 'Office furniture and fittings', items: 1, reorderLevel: 2, defaultUnit: 'pcs', status: 'Active' },
  { key: '5', name: 'Networking', description: 'Network cables, connectors, switches', items: 1, reorderLevel: 20, defaultUnit: 'pack', status: 'Active' },
  { key: '6', name: 'Stationery', description: 'Office stationery and supplies', items: 1, reorderLevel: 10, defaultUnit: 'ream', status: 'Active' },
  { key: '7', name: 'Tools', description: 'Hand tools and power tools', items: 0, reorderLevel: 5, defaultUnit: 'pcs', status: 'Active' },
];

const initMovements = [
  { key: '1', date: '2024-04-07 10:30', product: 'MacBook Pro M2', sku: 'LAP-MBP-001', category: 'Laptops', type: 'Stock In', quantity: 5, balanceBefore: 10, balanceAfter: 15, reference: 'PO-2024-001', notes: 'Received from Apple India', user: 'Admin' },
  { key: '2', date: '2024-04-07 14:15', product: 'Logitech MX Master 3', sku: 'ACC-LOG-005', category: 'Accessories', type: 'Stock Out', quantity: -2, balanceBefore: 27, balanceAfter: 25, reference: 'REQ-041', notes: 'Issued to Design Team', user: 'Manager' },
  { key: '3', date: '2024-04-06 11:00', product: 'Dell UltraSharp 27"', sku: 'MON-DLL-022', category: 'Electronics', type: 'Adjustment', quantity: -3, balanceBefore: 8, balanceAfter: 5, reference: 'ADJ-007', notes: 'Physical count correction', user: 'Admin' },
  { key: '4', date: '2024-04-05 09:45', product: 'RJ45 Connectors (Pack/100)', sku: 'NET-CON-100', category: 'Networking', type: 'Stock In', quantity: 50, balanceBefore: 35, balanceAfter: 85, reference: 'PO-2024-003', notes: 'New stock received', user: 'Admin' },
  { key: '5', date: '2024-04-04 16:30', product: 'A4 Copy Paper (Ream)', sku: 'STA-PAP-500', category: 'Stationery', type: 'Stock Out', quantity: -7, balanceBefore: 10, balanceAfter: 3, reference: 'REQ-039', notes: 'Monthly office supply issue', user: 'Manager' },
  { key: '6', date: '2024-04-03 13:00', product: 'Herman Miller Aeron', sku: 'FUR-HMN-010', category: 'Furniture', type: 'Transfer', quantity: -2, balanceBefore: 2, balanceAfter: 0, reference: 'TRF-003', notes: 'Transferred to Site Store', user: 'Admin' },
];
