    ...
    >
      <div
        style={{
          ...
          height: 36,
          borderRadius: 10,
          background: 'linear-gradient(135deg, #B19625 0%, #D4B96E 100%)',
          display: 'flex',
          alignItems: 'center',
          ...
          fontSize: 17,
          flexShrink: 0,
          boxShadow: '0 4px 12px rgba(177,150,37,0.35)',
        }}
      >
        P
      </div>
        ...
        return (
          ...
          >
            <div
              ...
              className={`nav-item ${isActive ? 'active' : ''} animate-fade-in`}
              style={{
              ...
              onMouseEnter={e => {
                if (!isActive) {
                  ...
                  e.currentTarget.style.paddingLeft = collapsed && !isMobile ? '0' : '18px';
                }
              }}
              onMouseLeave={e => {
                if (!isActive) {
                  ...
                  e.currentTarget.style.paddingLeft = collapsed && !isMobile ? '0' : '14px';
                }
              }}
            >
